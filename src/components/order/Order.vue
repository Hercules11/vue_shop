    ...
    <el-card class="box-card">
      <el-row :gutter="20">
        <el-col :span="8">
          ...
          >
            <el-button slot="append" icon="el-icon-search" @click="getOrdersList" />
          </el-input>
        </el-col>
      </el-row>
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-tooltip :enterable="false" class="item" content="修改地址" effect="dark" placement="top">
              <el-button icon="el-icon-edit" size="mini" type="primary" @click="showBox" />
            </el-tooltip>
    ...
    >
      ...
      >
        ...
        <el-form-item label="详细地址" prop="detailAdd">
          <el-input v-model="addressForm.detailAdd" />
        </el-form-item>
      </el-form>
    </el-dialog>
